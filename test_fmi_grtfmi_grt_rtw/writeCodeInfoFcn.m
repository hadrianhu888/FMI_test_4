% Autogenerated file: Sun Sep 25 16:56:20 2022
...
wr = coder.internal.writeDataInterfacesToCodeDescriptor("test_fmi_grtfmi",pwd) ;
...
skippedParameters = [];
    ...
    tmpActualReturn = RTW.DataInterface.empty;
            ...
            type_RTModel.Identifier = 'RT_MODEL_test_fmi_grtfmi_T';
        ...
        Var_RTModel = RTW.Variable(type_RTModel, 'test_fmi_grtfmi_M_');
        Var_RTModel.Owner           = '';
        Var_RTModel.DeclarationFile = '';
        

        % Pointer Variable: PtrVar_RTModel
        PtrVar_RTModel = RTW.PointerVariable(Ptrtype_RTModel_1_0, 'test_fmi_grtfmi_M', Var_RTModel);
        ...
        idata_RTModel = RTW.DataInterface('', 'RTModel', PtrVar_RTModel, empty_timing);
            ...
            writeCodeInfoFcn_RTArg.Name   = 'test_fmi_grtfmi_M';
    ...
    func_Initialize_Prototype.Return     = tmpRet;
        ...
        func_Initialize_Prototype.HeaderFile = 'test_fmi_grtfmi.h';
    func_Initialize_Prototype.SourceFile = 'test_fmi_grtfmi.c';
    ...
    func_Initialize_Interface.ActualReturn = tmpActualReturn;
        ...
        func_Initialize_Prototype.Name = 'test_fmi_grtfmi_initialize';
    ...
    Registration_RTArg.Name   = 'test_fmi_grtfmi_M';
    ...
    func_test_fmi_grtfmi_Prototype = coder.types.Prototype;
    func_test_fmi_grtfmi_Prototype.Arguments  = tmpArgs;
    func_test_fmi_grtfmi_Prototype.Return     = tmpRet;

        func_test_fmi_grtfmi_Prototype.HeaderFile = 'test_fmi_grtfmi.h';
    func_test_fmi_grtfmi_Prototype.SourceFile = 'test_fmi_grtfmi.c';

    func_test_fmi_grtfmi_Interface = RTW.FunctionInterface;
    func_test_fmi_grtfmi_Interface.Prototype    = func_test_fmi_grtfmi_Prototype;
    func_test_fmi_grtfmi_Interface.ActualArgs   = tmpActualArgs;
    func_test_fmi_grtfmi_Interface.ActualReturn = tmpActualReturn;

        func_test_fmi_grtfmi_Prototype.Name = 'test_fmi_grtfmi';
    time_constant = codeInfo.TimingProperties(getIndexFromTimingInternalId(codeInfo.TimingInternalIds, -1));
        func_test_fmi_grtfmi_Interface.Timing = time_constant;
        codeInfo.AllocationFunction =  [codeInfo.AllocationFunction, func_test_fmi_grtfmi_Interface'];
    ...
    func_OutputUpdate_Prototype.Return     = tmpRet;
        ...
        func_OutputUpdate_Prototype.HeaderFile = 'test_fmi_grtfmi.h';
    func_OutputUpdate_Prototype.SourceFile = 'test_fmi_grtfmi.c';
    ...
    func_OutputUpdate_Interface.ActualReturn = tmpActualReturn;
            ...
            func_OutputUpdate_Prototype.Name = 'test_fmi_grtfmi_step';
    ...
    func_Terminate_Prototype.Return     = tmpRet;
        ...
        func_Terminate_Prototype.HeaderFile = 'test_fmi_grtfmi.h';
    func_Terminate_Prototype.SourceFile = 'test_fmi_grtfmi.c';
    ...
    time_constant = codeInfo.TimingProperties(getIndexFromTimingInternalId(codeInfo.TimingInternalIds, -1));
        func_Terminate_Interface.Timing = time_constant;
                func_Terminate_Prototype.Name = ['test_fmi_grtfmi_terminate'];
