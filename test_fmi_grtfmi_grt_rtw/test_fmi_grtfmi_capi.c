...
#include "test_fmi_grtfmi_capi_host.h"
...
static rtwCAPI_BlockParameters rtBlockParameters[] = {
   ...
   */
  { 0, TARGET_STRING("test_fmi_grtfmi/IOGain"),
...
static rtwCAPI_Signals rtRootInputs[] = {
   ...
   * signalName, portNumber, dataTypeIndex, dimIndex, fxpIndex, sTimeIndex
   */
  { 1, 0, TARGET_STRING("test_fmi_grtfmi/In"),
...
static rtwCAPI_Signals rtRootOutputs[] = {
   ...
   * signalName, portNumber, dataTypeIndex, dimIndex, fxpIndex, sTimeIndex
   */
  { 2, 0, TARGET_STRING("test_fmi_grtfmi/Out"),
    TARGET_STRING(""), 1, 0, 0, 0, 0 },
...
void test_fmi_grtfmi_InitializeDataMapInfo(RT_MODEL_test_fmi_grtfmi_T *const
  test_fmi_grtfmi_M)
{
  ...
  rt_FREE( rtwCAPI_GetDataAddressMap( &(test_fmi_grtfmi_M->DataMapInfo.mmi) ) );
  ...
  rtDataAddrMap[0] = (void* )(&test_fmi_grtfmi_P.IOGain_Gain);
  rtDataAddrMap[1] = (void* )(&test_fmi_grtfmi_U->In);
  rtDataAddrMap[2] = (void* )(&test_fmi_grtfmi_Y->Out);
  rt_FREE( rtwCAPI_GetVarDimsAddressMap( &(test_fmi_grtfmi_M->DataMapInfo.mmi) )
          );
  ...
  /* Set C-API version */
  rtwCAPI_SetVersion(test_fmi_grtfmi_M->DataMapInfo.mmi, 1);

  /* Cache static C-API data into the Real-time Model Data structure */
  rtwCAPI_SetStaticMap(test_fmi_grtfmi_M->DataMapInfo.mmi, &mmiStatic);

  /* Cache static C-API logging data into the Real-time Model Data structure */
  rtwCAPI_SetLoggingStaticMap(test_fmi_grtfmi_M->DataMapInfo.mmi, (NULL));

  /* Cache C-API Data Addresses into the Real-Time Model Data structure */
  rtwCAPI_SetDataAddressMap(test_fmi_grtfmi_M->DataMapInfo.mmi, rtDataAddrMap);

  /* Cache C-API Data Run-Time Dimension Buffer Addresses into the Real-Time Model Data structure */
  rtwCAPI_SetVarDimsAddressMap(test_fmi_grtfmi_M->DataMapInfo.mmi,
    rtVarDimsAddrMap);

  /* Cache the instance C-API logging pointer */
  rtwCAPI_SetInstanceLoggingInfo(test_fmi_grtfmi_M->DataMapInfo.mmi, (NULL));

  /* Set reference to submodels */
  rtwCAPI_SetChildMMIArray(test_fmi_grtfmi_M->DataMapInfo.mmi, (NULL));
  rtwCAPI_SetChildMMIArrayLen(test_fmi_grtfmi_M->DataMapInfo.mmi, 0);
}
