 ...
 *  from Simulink model "test_fmi_rtwsfncfmi_cosim".
 *
...
#define RTW_GENERATED_SFCN_TUNABLE_PRMS_test_fmi_rtwsfncfmi_cosim_sf
...
#include "test_fmi_rtwsfncfmi_cosim_sf.c"
