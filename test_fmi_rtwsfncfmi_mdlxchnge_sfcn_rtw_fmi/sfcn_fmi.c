 ...
 *  from Simulink model "test_fmi_rtwsfncfmi_mdlxchnge".
 *
...
#define RTW_GENERATED_SFCN_TUNABLE_PRMS_test_fmi_rtwsfncfmi_mdlxchnge_sf
...
#include "test_fmi_rtwsfncfmi_mdlxchnge_sf.c"
